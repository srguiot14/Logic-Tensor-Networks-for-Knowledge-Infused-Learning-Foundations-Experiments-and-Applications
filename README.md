...
The whole code, until 28.6.2026, is the result of a final Master's Thesis of the [Master's Degree in Fundamental Principles of Data Science](https://web.ub.edu/en/web/estudis/w/masterdegree-md901) supervised by Oriol Pujol i Vila, PhD. The [Master's Thesis report](https://github.com/srguiot14/Logic-Tensor-Networks-for-Knowledge-Infused-Learning-Foundations-Experiments-and-Applications/blob/main/TFM_LTN_Quim_Guiot_UB_2026.pdf) is published in this repository in a PDF format. To summary all the contents I explained in the report, it is possible to consult the [slides of the presentation](https://github.com/srguiot14/Logic-Tensor-Networks-for-Knowledge-Infused-Learning-Foundations-Experiments-and-Applications/blob/main/Slides_TFM_LTN_Quim_Guiot_Cusido.pdf). Any contribution or idea to continue the lines of the proposed work will be very welcome.
